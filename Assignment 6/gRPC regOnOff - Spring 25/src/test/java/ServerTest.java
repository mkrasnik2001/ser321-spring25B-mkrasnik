...
//         SortRequest emptyReq = SortRequest.newBuilder()
//             .setAlgo(Algo.INTERN)
//             .build();
//         SortResponse emptyResp = sortStub.sort(emptyReq);
//         assertTrue(emptyResp.getIsSuccess());
//         assertTrue(emptyResp.getDataList().isEmpty());
//     }
